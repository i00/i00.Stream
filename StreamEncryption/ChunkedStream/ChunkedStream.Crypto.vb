...
Namespace Streams
    ...
    Partial Class ChunkedStream
        ...
        Private Sub DecryptChunkRecord(ExpectedChunkIndex As Long, Record As Byte(), Plain As Byte())
            ...
            Dim CompressionMethod = CType(BitConverter.ToInt32(Record, ChunkCompressionMethodOffset), ChunkedStreamOptions.CompressionMethods)
            ...
            If PayloadLength < 0 OrElse ChunkRecordDataOffset + PayloadLength + MacSize <> Record.Length Then Throw New InvalidDataException("Invalid chunk payload length.")
