...
#If DEBUG Then
        ...
        Friend _DebugDirectoryTicks As Long
        Friend _DebugRootTicks As Long
        Friend _DebugHeaderTicks As Long

        Friend _DebugPersistCount As Long
        Friend _DebugLastPersistIndexPageCount As Integer
        Friend _DebugTotalPersistIndexPages As Long

        Public Sub DebugResetMetadataCounters()
            _DebugPersistTicks = 0
            _DebugIndexPageTicks = 0
            _DebugDirectoryTicks = 0
            _DebugChunkDirectoryTicks = 0
            _DebugHoleDirectoryTicks = 0
            _DebugRootTicks = 0
            _DebugHeaderTicks = 0
            _DebugPersistCount = 0
            _DebugLastPersistIndexPageCount = 0
            _DebugTotalPersistIndexPages = 0
        End Sub

        Public ReadOnly Property DebugPersistMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugPersistTicks).TotalMilliseconds
            End Get
        End Property

        Public ReadOnly Property DebugIndexPageMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugIndexPageTicks).TotalMilliseconds
            End Get
        End Property

        Public ReadOnly Property DebugDirectoryMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugDirectoryTicks).TotalMilliseconds
            End Get
        End Property

        Public ReadOnly Property DebugRootMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugRootTicks).TotalMilliseconds
            End Get
        End Property

        Public ReadOnly Property DebugHeaderMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugHeaderTicks).TotalMilliseconds
            End Get
        End Property

        Public ReadOnly Property DebugPersistCount As Long
            Get
                Return _DebugPersistCount
            End Get
        End Property

        Public ReadOnly Property DebugLastPersistIndexPageCount As Integer
            Get
                Return _DebugLastPersistIndexPageCount
            End Get
        End Property

        Public ReadOnly Property DebugAveragePersistIndexPageCount As Double
            Get
                If _DebugPersistCount <= 0 Then Return 0
                Return CDbl(_DebugTotalPersistIndexPages) / CDbl(_DebugPersistCount)
            End Get
        End Property

        Public ReadOnly Property DebugAveragePersistMilliseconds As Double
            Get
                If _DebugPersistCount <= 0 Then Return 0
                Return DebugPersistMilliseconds / CDbl(_DebugPersistCount)
            End Get
        End Property

        Friend _DebugChunkDirectoryTicks As Long
        Friend _DebugHoleDirectoryTicks As Long

        Public ReadOnly Property DebugChunkDirectoryMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugChunkDirectoryTicks).TotalMilliseconds
            End Get
        End Property

        Public ReadOnly Property DebugHoleDirectoryMilliseconds As Double
            Get
                Return TimeSpan.FromTicks(_DebugHoleDirectoryTicks).TotalMilliseconds
            End Get
        End Property
